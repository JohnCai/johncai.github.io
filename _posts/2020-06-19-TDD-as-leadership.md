...
- 要做 TDD，就得有 OOP 的嫩两个i，就要掌握 SOLID 原则；
...
刚开始是他们看我重构。我变重构边讲，背后的原则是什么，为什么要这么做，等等。
...
想象一下，如果「程序员甲」开发功能 A 后带来的成本是 10 天；而如果他什么也不做，交由「程序员乙」去开发，开发时间为 2 天，带来的成本为 3 天。则「程序员甲」能对团队做的最大贡献，就是什么都不要做。
